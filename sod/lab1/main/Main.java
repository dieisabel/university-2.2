...
public class Main {
    ...
    private long solution4(int[] array) {
        ...
        long time = end - start;
        System.out.println("Solution 4: time = " + time);
        return time;
    }
    ...
    private void solution6(int[] array, int key) {
        ...
        int linCount = Utility.getLinearCounter();
        int binCount = Utility.getBinaryCounter();
        System.out.println("Diff between comparisons: " +
            (linCount - binCount));
    }
}
